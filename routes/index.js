...
const userColorPriceRoutes = require('./userColorPrice.routes');
...
router.use('/user-color-prices', userColorPriceRoutes);
router.use('/user-color-price', userColorPriceRoutes);
